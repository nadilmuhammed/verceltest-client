...
const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const update = await axios.put(`/api/auth/update/${id}`, {
  ...
  const fetchData = async (id) => {
    try {
      const response = await axios.get(`/api/auth/getusersbyid/${id}`);
  ...
  return (
    <div className="flex justify-center items-center">
      <div className="mt-10">
        <h1 className="text-3xl font-[550] text-center">Update your Profile</h1>
        <form
        ...
        <div className="w-full mt-14">
          <button
            ...
            className="btn flex justify-center items-center text-red-600 bg-transparent border-none w-full rounded-full hover:bg-transparent"
          >
            <GiTrashCan size={20} />
